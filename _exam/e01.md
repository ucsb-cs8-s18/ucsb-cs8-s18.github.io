...
* [HTML](cs8_s18_e01/){: data-ajax="false"}
* [Handout](handout/){: data-ajax="false"}
* [PDF](cs8_s18_e01.pdf){: data-ajax="false"}

* [seating charts](seating){: data-ajax="false"}

* The page [typos and hints](typos){: data-ajax="false"} will show any typo corrections or hints offered while the exam is in progress, along with a countdown clock showing the time remaining.
