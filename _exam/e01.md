...
* [Seating Charts](https://ucsb-cs8-s18.github.io/exams/e01/seating/){: data-ajax=false}

* The page [typos and hints](https://ucsb-cs8-s18.github.io/exams/e01/typos/){: data-ajax=false} will show any typo corrections or hints offered while the exam is in progress, along with a countdown clock showing the time remaining.
